...
<meta http-equiv="description" content="css?"> 
      ...
      <div class="loginForm_content"> 
        ...
        <fieldset> 
          ...
          <div class="inputWrap"> 
            ...
            <input id="itcode"  name="itcode" onblur="check_itcode" type="text"  placeholder="请输入itcode" autofocus required> 
          ...
          <div class="inputWrap"> 
           ...
           <div class="inputWrap" > 
            ...
            <input  id="vali_code" name="vali_code" type="text" width="4" placeholder="请输入验证码?" required>
          </div> 
          <img  id="img1"  name = "img1" alt="" src="Vali_Code" onclick="changeimg()"> 
