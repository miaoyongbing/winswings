...
function abc(){
	if(document.getElementById("text").value.length!=0){
		...
		var url="chatroom?record="+record;
	...
	for(var j=0;j<5;j++,i++){
		...
		var s="<div class='msg'>"+
					...
					"<div class='msg_body'>"+
						...
						"<div class='message'>"+"这是一条简单的测试"+"  "+c1+"</div>"+
					"</div>"+
				"</div>";
		var r=document.getElementById("record");
		r.innerHTML+=s;
...
<div id="D">
	<div id="userhead">
		<div class="logo"><img src="image/logo.png" width="400px" height="50px" style="margin-top:3px;"></div>
		<ul class="menu"><img src='image/drop_down.png' height='40px' width='40px'></a>
			<li>弹出菜单1</li>
            <li>弹出菜单2</li>
       	</ul>
	</div>
	<div>
		<div class="chatbroad">
			...
			<div class="chatting">
				<form name="form1">
					<div class="chatting_head"><input type="button" class="btn" value="测试3" onclick="add2()"><input type="button" class="btn" value="测试2" onclick="add()"><input type="button" class="btn" value="测试" onclick="getrecord()"><input type="button" value="发言" class="btn" onclick="abc()"></div>
					<div class="chatting_body"><textarea name="text" id="text" style="margin:1px 0 0 6px;width:644px; height:60px; border:0 none; outline:none;"></textarea></div>
				</form>
			</div>
		</div>
		<div class="userlist">
			<div class="userlist_head">好友列表</div>
