...
<body style="background-color:#DDF0ED">
<div class="Body">
	<div class="broad">
		<div class="broadon">
			<div class="broadon-out">
				<div class="broadon-inner" id="D7" style="background-color:red;height:500px;top:0px;left:0px;">
					<img src="img/logo.png" style="margin-left:180px;margin-top:150px;">
					<img src="img/welcome.png" width=900px height=100px style="margin-left:150px;">
				</div>
				<div id="D2" style="position:absolute;top:-500px;left:0px;width:740px;height:500px;">
				<div id="btnbroad2">
					...
					<div class="broadon-inner" id="d21" style="background-color:#5AF580;height:420px;left:0px;">
						<div id="form2" style="background-color:#5AF580;height:420px;top:40px;width:720px;">
					...
					<div class="broadon-inner" id="d22" style="background-color:#FFE6EB;height:420px;">
					        <table style="display:block;color:#FFFFFF;text-shadow:1px 1px 1px #000000;" id="d2tab1">
				...
				<div id="D3" style="position:absolute;top:-500px;left:0px;width:740px;height:500px;">
					<div id="btnbroad3">
					...
					<div class="broadon-inner" id="d31" style="background-color:#FFFFFF;height:420px;left:0px;">
						<input type="button"  onclick="sendd3(1)" id="d3-btn1" value="开启第一轮红包雨" class="innerbtn" style="color:#FFFFFF;top:100px;left:260px;width:200px;background-color:#FF4238">
						<input type="button"  onclick="sendd3(2)" id="d3-btn2" value="开启第二轮红包雨" class="innerbtn" style="color:#FFFFFF;top:150px;left:260px;width:200px;background-color:#FF4238">
						<input type="button"  onclick="sendd3(3)" id="d3-btn3" value="开启第三轮红包雨" class="innerbtn" style="color:#FFFFFF;top:200px;left:260px;width:200px;background-color:#FF4238">
					</div>
					<div class="broadon-inner" id="d32" style="background-color:#E6CFB5;height:420px;;">
						<div id="d3f1" style="background-color:#F5675D;height:420px;top:40px;width:720px;">
				...
				<div id="D4" style="position:absolute;top:-500px;left:0px;width:740px;height:500px;">
					<div id="btnbroad4">
				...
				<div id="D5" style="position:absolute;top:-500px;left:0px;width:740px;height:500px;">
					<div id="btnbroad5">
				...
				<div id="D1" style="position:absolute;top:-500px;left:0px;width:740px;height:500px;">
					<div id="btnbroad">
					...
					<div class="broadon-inner" id="d3" style="background-color:#73D99A;height:420px;">
						...
						<div class="Text" style="top:150px;left:180px;">密码修改为：</div><input type="text" id="d13-t2" style="top:145px;left:300px;">
					...
					<div class="Text" style="top:100px;left:180px;">当前红包数:</div><div class="Text" id="d14-t1" style="top:100px;left:380px;"></div>
	...
	<div class="broadText" style="top:576px;">胜翼组出品</div>
</div>
<script type="text/javascript">
